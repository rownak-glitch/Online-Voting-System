...
<div id="main-wrapper">
    ...
    <div class="login-popup-wrap new_login_popup">
        ...
        <form id="loginMember" role="form" action="login.php" method="post">
            ...
            <button type="submit" class="login_button" name="login_user" value="1">Login</button>
        </form>
        <br/>
        <div class="form-group text-center">
            <a class="pwd-forget" href="javascript:void(0)" id="open_forgotPassword">Forgot Password</a>
        </div>
        <div class="text-center"><p>Don't have an account? <a href="registration.php">Sign up now</a>.</p>
