...
<div class="inner_container">
    ...
    //    print_r($r1);
    //print_r($r2);
    echo "<h5>Your Current Information  :</h5>";
    echo "<h5>------------------------------------------------------------</h5>";
    echo "<h5>Voter ID : {$r1['user_id']}</h5>";
    echo "<h5>Name     : {$r1['name']}</h5>";
    echo "<h5>Gender   : {$r1['gender']}</h5>";
    echo "<h5>Age      : {$r1['age']}</h5>";
    echo "<h5>------------------------------------------------------------</h5>";
    ?>
</div>
<!-- /.container -->
...
<!-- Page Content -->
<div class="inner_container">
    <h3 class="mt-4"> Update your Information: </h3>
    <p>

    <form method="post" action="validation.php">

        <div class="form-group">
            <input type="int" class="form-control" id="user_id" placeholder="Name" name="name">
        </div>
        <div class="form-group">
        ...
        <div class="form-group"><input type="text" class="form-control" id="id" placeholder="Gender" name="gender">
        </div>
        <div class="form-group">
            <input type="int" class="form-control" id="age" placeholder="Age" name="age">
        </div>

        <button type="submit" class="back_btn1" name="voter_update">Update</button>
